...
class Vendors extends CI_Controller {
	...
	public function index()
	{
	    ...
	    $allrecord = $this->Vendors_model->get_vendor_count($title);
		...
		$data['datas'] = $this->Vendors_model->get_vendor_list($data['limit'],$data['offset'],$title);
	...
	public function get_vendor_by_id()
	{
		...
		$res = $this->Vendors_model->get_vendor_by_id($v_id);
	...
	public function edit_vendor()
	{
		...
		$res = $this->Vendors_model->edit_vendor($data);
	...
	public function change_status()
	{
		...
		$this->db->update('tbl_vendors', $update);
