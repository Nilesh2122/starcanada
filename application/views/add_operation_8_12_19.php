    ...
    <div class="forms">
    	...
    	<div class=" form-grids row form-grids-right" style="margin-top:0">
            <div class="widget-shadow " data-example-id="basic-forms"> 
                ...
                <div class="form-body">
                <form action="<?php echo base_url(); ?>index.php/operations/add_operation" method="post" class="form-horizontal" onsubmit="return check_form();">  
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9"> <textarea class="form-control" name="op_product_description" placeholder="Product description" required="required" rows="4"></textarea></div> 
                    </div>
                    
                    <div class="form-group"> 
                        <label for="inputEmail3" class="col-sm-2 control-label">Special notes</label> 
                        <div class="col-sm-9"> <textarea class="form-control" name="op_special_notes" placeholder="Special notes" required="required" rows="4"></textarea></div> 
                    </div>                                       
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9"> <input type="text" class="dp form-control" name="op_loading_date" required="required"> </div> 
                    </div>
                    
                    <div class="form-group"> 
                        <label for="inputEmail3" class="col-sm-2 control-label">Loading time<br />(Scheduled)</label> 
                        <div class="col-sm-9"> <input type="text" class="tp form-control" name="op_loading_s_time" required="required"> </div> 
                    </div>                                                             
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="col-sm-9"> <input type="text" class="dp form-control" name="op_delivery_date" required="required"> </div> 
                    </div>
                    
                    <div class="form-group"> 
                        <label for="inputEmail3" class="col-sm-2 control-label">Delivery time<br />(Scheduled)</label> 
                        <div class="col-sm-9"> <input type="text" class="tp form-control" name="op_delivery_s_time" required="required"> </div> 
                    </div>
                    
                    <div class="form-group"> 
                        <label for="inputEmail3" class="col-sm-2 control-label">Operation cost</label> 
                        <div class="col-sm-9"> <input type="text" class="form-control" name="op_total_cost" id="op_total_cost" required="required"> 
