...
<html>
<head>
<title>Reset Password - STAR CANADA</title>
    ...
    <div class="main-page login-page ">        
        <div class="widget-shadow" style="border-radius: 25px;">
            ...
            <div class="login-body" style="border-bottom-left-radius: 25px;border-bottom-right-radius: 25px;">
                <h4 style="margin-bottom: 20px;font-size: 18px;color: #323232;border-bottom: 1px solid #ddd;padding-bottom: 12px;letter-spacing: 2px;">Enter New Password</h4>

                <form autocomplete="off" method="post" action="<?php echo base_url(); ?>index.php/users/reset_password_process?reset=<?php echo isset($_GET['reset']) ? $_GET['reset'] : ''; ?>">
                    <div style="position:relative;">
                        <input type="password" class="user" name="password" placeholder="New Password" required>
                        <div class="lock"></div>
                    </div>                    
